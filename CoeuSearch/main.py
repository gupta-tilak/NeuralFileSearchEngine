...
class File:
  def __init__(self, path, ftype):
    ...
    def setFileConfig(self):
        ...
        temp_path = self.path.replace(os.path.sep, "_").replace(":", "_").replace(".", "_")
        self.content_cache_path = os.path.join(cache_base_path, os.path.basename(temp_path) + "__content.txt")
        self.title_embed_cache_path = os.path.join(cache_base_path, os.path.basename(temp_path) + "__title.npy")
        self.content_embed_cache_path = os.path.join(cache_base_path, os.path.basename(temp_path) + "__content.npy")
